package com.ruoyi.project.wms.shopmanage.demand.controller;
...
import com.ruoyi.project.wms.shopmanage.demand.service.ITDemandService;
 ...
 */
@Controller
@RequestMapping("/shopmanage/demand")
public class TDemandController extends BaseController
{
    private String prefix = "wms/shopmanage/demand";

    @Autowired
    private ITDemandService tDemandService;

    @RequiresPermissions("shopmanage:demand:view")
    @GetMapping()
     ...
     * 查询【请填写功能名称】列表
     */
    @RequiresPermissions("shopmanage:demand:list")
    @PostMapping("/list")
    @ResponseBody
     ...
     * 导出【请填写功能名称】列表
     */
    @RequiresPermissions("shopmanage:demand:export")
     ...
     * 新增保存【请填写功能名称】
     */
    @RequiresPermissions("shopmanage:demand:add")
     ...
     * 修改保存【请填写功能名称】
     */
    @RequiresPermissions("shopmanage:demand:edit")
     ...
     * 删除【请填写功能名称】
     */
    @RequiresPermissions("shopmanage:demand:remove")
